...
#[openapi(
    paths(
        ...
        super::handlers::analyze_disk_health,
        super::handlers::start_migration,
        super::handlers::pause_migration,
        super::handlers::resume_migration,
        super::handlers::join_cluster,
        super::handlers::list_cluster_nodes,
        super::handlers::sync_cluster_metadata,
    ...
    tags(
        ...
        (name = "migrations", description = "Array migration endpoints"),
        (name = "cluster", description = "Cluster metadata endpoints"),
    ),
    info(
        title = "rmdadm API",
        version = "0.1.0",
